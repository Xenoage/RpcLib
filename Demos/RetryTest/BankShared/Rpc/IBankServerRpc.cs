...
namespace BankShared.Rpc {
    ...
    public interface IBankServerRpc : IRpcFunctions {
        ...
        /// Retrying this command is not required, since it does not modify state on the bank server.
        /// </summary>
        ...
        /// This command should be retried until the bank server is finally reached,
